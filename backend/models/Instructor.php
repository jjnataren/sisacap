...
class Instructor extends \yii\db\ActiveRecord
{
	...
	public static function getTypeInstructor(){
		...
		return [Instructor::TIPO_AGENTE_CAP_INTERNO=>'Agente capacitador interno',
				self::TIPO_AGENTE_EXT_IND=>'Agente capacitador externo con numero de acreditaciÃ³n, independiente',
				self::TIPO_AGENTE_ACREDITACION=>'Agente capacitador externo con numero de acreditaciÃ³n, perteneciente a una empresa ',
