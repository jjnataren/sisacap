...
$this->title = 'Catálogo de areas tematicas.';
...
<div class="catalogo-index">
    ...
    <p>
        <?= Html::a('Crear nuevo', ['area-crear'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
    		...
    		'urlCreator' => function ($action, $model, $key, $index) {
    			...
    			if ($action === 'update') {
    				return Yii::$app->urlManager->createUrl(['/catalogo/area-actualizar', 'id' => $key]); // Aqui es donde se crean las urls con las acciones personalizadas
    		
    			}
    				
    			if ($action === 'delete') {
    				return Yii::$app->urlManager->createUrl(['/catalogo/area-borrar', 'id' => $key]); // Aqui es donde se crean las urls con las acciones personalizadas
