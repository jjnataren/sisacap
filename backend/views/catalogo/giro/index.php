...
$this->title = 'Catálogo nacional de giros.';
...
<div class="catalogo-index">
    ...
    <p>
        <?= Html::a('Crear nuevo', ['giro-crear'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
    		...
    		'urlCreator' => function ($action, $model, $key, $index) {
    			...
    			if ($action === 'update') {
    				return Yii::$app->urlManager->createUrl(['/catalogo/giro-actualizar', 'id' => $key]); // Aqui es donde se crean las urls con las acciones personalizadas
    		
    			}
    				
    			if ($action === 'delete') {
    				return Yii::$app->urlManager->createUrl(['/catalogo/giro-borrar', 'id' => $key]); // Aqui es donde se crean las urls con las acciones personalizadas
