...
foreach ($model->iDPLAN->planEstablecimientos as $establecimiento){
	...
	$tabs[]=[
            ...
            'url' => ['/constancias/view-course-constancia', 'id'=>$model->ID_CURSO, 'id_est'=>$establecimiento->ID_EMPRESA, '#'=>'constancias'],
            'linkOptions' => [],
        ]; 
...
'label' =>'<i class="fa fa-building">
							 ...
							 'url' => ['/constancias/view-course-constancia', 'id'=>$model->ID_CURSO,'is_company'=>true, '#'=>'constancias'],
							 'linkOptions' => [],
							 ];
