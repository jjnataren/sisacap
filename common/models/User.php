...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return $this->hasMany(EmpresaUsuario::className(), ['ID_USUARIO' => 'id']);
    }
    ...
    {
        return $this->hasMany(Empresa::className(), ['ID_EMPRESA' => 'ID_EMPRESA'])->viaTable('tbl_empresa_usuario', ['ID_USUARIO' => 'id']);
    }
