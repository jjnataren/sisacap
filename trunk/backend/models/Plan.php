...
class Plan extends \yii\db\ActiveRecord
{
	...
	public function validateVigencia($attribute, $params){
		...
		if ($total_days > $max_days){
			$this->addError($attribute, 'La vigencia debe ser hasta  dos aÃ±os');
			$this->addError('VIGENCIA_FIN', 'La vigencia debe ser hasta dos aÃ±os');
 ...
 /**
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ESTATUS' => 'Estatus',
            'MODALIDAD_CAPACITACION' => 'Modalidad de capacitaciÃ³n',
            'ACTIVO' => 'Activo',
            'MODALIDAD' => 'Modalidad',
            'OBJETIVO1' => 'Objetivo1',
            'OBJETIVO2' => 'Objetivo2',
