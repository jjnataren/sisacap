...
use backend\models\Catalogo; ?>
	...
	* { margin:0;}
	...
	.P400 { color:#ffffff; font-size:10pt; font-weight:bold; text-align:center ! important; font-family:Arial; writing-mode:lr-tb; }
	...
	.T22 { font-family:Arial Narrow; font-size:7pt; font-weight:bold; }
	...
	?>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="Tabla1">
			...
			<tr class="Tabla11">
				...
				<td style="text-align:center;width:15.977cm; " class="Tabla1_B1">
					...
					</p><p class="P46">Formato DC-4</p><p class="P43">
						<span class="T6">LISTA DE CONSTANCIAS DE COMPETENCIAS O DE HABILIDADES LABORALES</span>
					</p>
				</td>
			</tr>
		</table><p class="P47"> </p>
		<table border="0" cellspacing="0" cellpadding="0" class="Tabla2">
			...
			<tr class="Tabla21">
				<td colspan="27" style="text-align:center;width:0.679cm; height:37px; " class="Tabla2_A1 P40">
							DATOS DE LA EMPRESA
				</td>
			</tr>
			<tr class="Tabla22">
				<td colspan="27" style="text-align:left;width:0.679cm;  vertical-align:top;" class="Tabla2_A2">
					<span class="P122">Nombre o razón social (En caso de persona física, anotar apellido paterno, apellido materno y nombre(s))</span>
				</td>
			</tr>
			<tr class="Tabla23">
				<td colspan="27" style="text-align:left;width:0.679cm; height:30px" class="Tabla2_A3">
					<span class="T28"><?=$company->NOMBRE_RAZON_SOCIAL?></span> 
				</td>
			</tr>
			<tr class="Tabla22">
				<td colspan="15" style="text-align:left;width:0.679cm; " class="Tabla2_A4">
					<span class="P122">Registro Federal de Contribuyentes con homoclave (SHCP)</span>
				</td>
				<td colspan="12" style="text-align:left; " class="Tabla2_S4">
						<span class="P122">Registro patronal del I.M.S.S.(Una letra o número y 10 dígitos)</span>
				</td>
			</tr>
			<tr class="Tabla25">
				<td style="text-align:center; vertical-align:middle; width:0.679cm; height:30 " class="Tabla2_A5 T28">
					<?=trim(isset($a_rfc[0])?$a_rfc[0]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
				...
				<td  style="text-align:center; vertical-align:middle; width:0.504cm; " class="Tabla2_A5 T28">
				...
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_nss[0])?$a_nss[0]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_nss[1])?$a_nss[1]:'') ?>
				</td>
				
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_nss[2])?$a_nss[2]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_nss[3])?$a_nss[3]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_nss[4])?$a_nss[4]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_nss[5])?$a_nss[5]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_nss[6])?$a_nss[6]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_nss[7])?$a_nss[7]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_nss[8])?$a_nss[8]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_nss[9])?$a_nss[9]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					-
				</td>
				<td style="text-align:center;width:0.679cm; vertical-align:middle;" class="Tabla2_e5 T28">
					<?=trim(isset($a_nss[10])?$a_nss[10]:'') ?>
				</td>
			</tr>
			<tr class="Tabla22">
				<td colspan="21" style="text-align:left;width:0.679cm; " class="Tabla2_A4">
					<span class="P122">Periodo de vigencia del plan (No deberá exceder de 2 años)</span>
				</td>
				<td colspan="6" rowspan="3" style="text-align:left; vertical-align: text-top;" class="Tabla2_S4">
						<span class="P122">Número de establecimientos considerados en la lista</span>
				</td>
			</tr>
			<tr class="Tabla23">
				<td colspan="3" style="text-align:left;width:0.679cm; height:30px" class="Tabla2_A99">
					<p class="P2"></p>
				</td>
				<td colspan="4" style="text-align:center;width:0.679cm; height:30px" class="Tabla3_A111">
					<span class="P122">
						Año
					</span>
				</td>
				<td colspan="2" style="text-align:center;width:0.679cm; height:30px" class="Tabla3_A111">
					<span class="P122">
						Mes</span>
				</td>
				<td colspan="2" style="text-align:center;width:0.679cm; height:30px" class="Tabla3_A111">
			...
			<tr class="Tabla36">
				<td colspan="3" style="text-align:left;width:0.679cm; height:10px" class="Tabla3_A10">
					<p class="P2"></p>
				</td>
				<td colspan="4" style="text-align:center;width:0.679cm; height:10px" class="Tabla3_A10">
					<p class="P2"></p>
				</td>
				<td colspan="2" style="text-align:center;width:0.679cm; height:10px" class="Tabla3_A10">
					<p class="P2"></p>
				</td>
				<td colspan="2" style="text-align:center;width:0.679cm; height:10px" class="Tabla3_A10">
					<p class="P2"></p>
			...
			<tr class="Tabla25">
				<td colspan="3" style="text-align:left; vertical-align:middle; width:0.679cm; height:30 " class="Tabla2_A5">
						<span class="P122">
						DEL
						</span>
				</td>
				...
				<td colspan="2" style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 P122">
					al
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=$a_fElab[0]?>
				...
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=round($establecimientos/100000)?:round($establecimientos/100000)?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=round($establecimientos/10000)?:round($establecimientos/10000)?>
				</td>
				<td colspan]="2" style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=round($establecimientos/1000)?:round($establecimientos/1000)?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=round($establecimientos/100)?:round($establecimientos/100)?>
				</td>
				<td colspan="2" style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_e5 T28">
						<?=round($establecimientos%10)?>
				</td>				
				
			</tr>
			<tr class="Tabla26">
				<td colspan="27" style="text-align:left;width:0.679cm; " class="Tabla2_A6">
					<span class="P122">Clave Única de Registro de Población. - En caso de persona física *</span>
				</td>
			</tr>
			<tr class="Tabla27">
				<td colspan="27" style="text-align:left;width:0.679cm; height:29px; " class="Tabla2_A7">
					<p class="P11"> </p><p class="P52">
						<span class="T28"><?=strtoupper($company->CURP) ?></span></p>
				</td>
			</tr>
			<tr class="Tabla26">
				<td colspan="14" style="text-align:left;width:0.679cm; " class="Tabla2_A8">
						<span class="P122">Calle</span>
				</td>
				<td colspan="3" style="text-align:left;width:0.679cm; " class="Tabla2_A8_BT">
						<span class="P122">No. Exterior</span>
				</td>
				<td colspan="3" style="text-align:left;width:0.679cm; " class="Tabla2_A8_BT">
						<span class="P122">No. Interior</span>
				</td>
				<td colspan="7" style="text-align:left;width:0.679cm; " class="Tabla2_A8_BTR">
						<span class="P122">Colonia</span>
				</td>
			</tr>
			<tr class="Tabla29">
				<td colspan="14" style="text-align:left;width:0.679cm; " class="Tabla2_A9">
						<span class="T28"><?= $company->CALLE ?></span>
				</td>
				<td colspan="3" style="text-align:left;width:0.191cm; " class="Tabla2_Q9">
						<span class="T28"><?= $company->NUMERO_EXTERIOR ?></span>
				</td>
				<td colspan="3" style="text-align:left;width:0.55cm; " class="Tabla2_V9">
						<span class="T28"><?= $company->NUMERO_INTERIOR ?></span>
				</td>
				<td colspan="7" style="text-align:left;width:0.727cm; " class="Tabla2_Y9">
					<p class="P6">
						<span class="T28"><?= $company->COLONIA ?></span></p>
				</td>
			</tr>
			<tr class="Tabla22">
				<td colspan="6" style="text-align:left; width:90px; " class="Tabla2_A10">
					<span class="P122">Código postal (5 dígitos)</span>
				</td>
				<td colspan="8" style="text-align:left;width:0.596cm; " class="Tabla2_H10">
					<span class="P122">Entidad federativa</span>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla2_Q10">
					<span class="P122">Municipio o delegación política</span>
				</td>
			</tr>
			<tr class="Tabla29">
				<td colspan="2" style="text-align:center; vertical-align: middle;  height:25px " class="Tabla2_A11">
					<span class="T28"><?=trim(isset($a_cp[4])?$a_cp[4]:'') ?></span>
				</td>
				<td style="text-align:center;width:0.684cm; vertical-align: middle; " class="Tabla2_B11">
					<span class="T28"><?=trim(isset($a_cp[3])?$a_cp[3]:'') ?></span>
				</td>
				<td style="text-align:center;width:0.693cm;vertical-align: middle; " class="Tabla2_C11">
					<span class="T28"><?=trim(isset($a_cp[2])?$a_cp[2]:'') ?></span>
				</td>
				<td style="text-align:center;width:0.693cm;vertical-align: middle; " class="Tabla2_D11">
					<span class="T28"><?=trim(isset($a_cp[1])?$a_cp[1]:'') ?></span>
				</td>
				<td  style="text-align:center;width:0.649cm;vertical-align: middle; " class="Tabla2_F11">
					<span class="T28"><?=trim(isset($a_cp[0])?$a_cp[0]:'') ?></span>
				</td>
				<td colspan="8" style="text-align:left;width:0.596cm; vertical-align: middle; " class="Tabla2_H11">
						<span class="T28"><?=trim(isset($entidadFederativa)?$entidadFederativa->NOMBRE:'') ?></span>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; vertical-align: middle;" class="Tabla2_Q11">
						<span class="T28"><?=trim(isset($mpio)?$mpio->NOMBRE:'') ?></span>
				</td>
			</tr>
			<tr class="Tabla26">
				<td colspan="14" style="text-align:left;width:0.679cm; " class="Tabla2_A12">
						<span class="P122">Localidad</span>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla2_Q12">
					<span class="P122">Teléfono (s)</span>
				</td>
			</tr>
			<tr class="Tabla213">
				<td colspan="14" style="text-align:left;width:0.679cm; height:20px; " class="Tabla2_A13">
					<p class="P6">
						</p>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla2_Q13">
						<span class="T28"><?= $company->TELEFONO?></span></p>
			</tr>
			<tr class="Tabla26">
				<td colspan="14" style="text-align:left;width:0.679cm; " class="Tabla2_A12">
						<span class="P122">Correo electrónico</span>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla2_Q12">
					<span class="P122">Fax</span>
				</td>
			</tr>
			<tr class="Tabla213">
				<td colspan="14" style="text-align:left;width:0.679cm; height:20px; " class="Tabla2_A13">
						<span class="T28"><?= $company->CORREO_ELECTRONICO?></span> 
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla2_Q13">
						<span class="T28"><?= $company->FAX?></span>
				</td>
			</tr>
			<tr class="Tabla26">
				<td colspan="27" style="text-align:left;width:0.679cm; " class="Tabla2_A122">
					<span class="P122">Actividad o giro principal</span>
				</td>
			
			</tr>
			<tr class="Tabla2_Q13">
				<td colspan="27"  style="text-align:left; vertical-align:middle; width:0.679cm; height:25px; " class="Tabla2_A15">
						<span class="T28"><?=trim(isset($giro)?$giro->NOMBRE:'') ?></span>
				</td>
				
			</tr>
			<tr class="Tabla215">
				<td rowspan = "2" colspan="9" style="text-align:left;width:0.679cm;  vertical-align:middle; " class="Tabla2_A14_1">
					<span class="P122">Número de constancias expedidas</span>
				</td>
				<td colspan="6" style="text-align:center;width:0.679cm; height:20px " class="Tabla2_A14_1">
					<span class="P122">Hombres</span>
				</td>
				<td colspan="6" style="text-align:center;width:0.679cm; height:20px " class="Tabla2_A14_1">
					<span class="P122">Mujeres</span>
				</td>
				<td colspan="6" style="text-align:center;width:0.679cm;  height:20px" class="Tabla2_A14_1">
					<span class="P122">Total</span>
				</td>
			</tr>
			<tr class="Tabla215">
				
				<td colspan="6" style="text-align:center;width:0.679cm;  height:30px " class="Tabla2_Q13">
				<span class="T28"><?= $model->CONSTANCIAS_HOMBRES?></span>
					
				</td>
				<td colspan="6" style="text-align:center;width:0.679cm;  height:30px " class="Tabla2_Q13">
					<span class="T28"><?= $model->CONSTANCIAS_MUJERES?></span>
				</td>
				<td colspan="6" style="text-align:center;width:0.679cm; height:30px " class="Tabla2_Q13">
					<span class="T28"><?= $model->CONSTANCIAS_HOMBRES + $model->CONSTANCIAS_MUJERES?></span>
				</td>
			</tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="Tabla3">
			...
			<tr class="Tabla35">
				<td colspan="31" style="text-align:center;width:1.282cm; " class="Tabla3_A5">
				<p class="P24"> </p>
					<h1 class="P39">
						<a id="a__Los_datos_se_proporcionan_bajo_protesta_de_decir_verdad__apercibidos_de_la_responsabilidad_en_que_incurre_todo">
							<span/>
						</a>Los datos se proporcionan bajo protesta de decir verdad, apercibidos de la responsabilidad en que incurre todo</h1>
				</td>
			</tr>
			<tr class="Tabla36">
				<td colspan="31" style="text-align:center;width:1.282cm; " class="Tabla3_A6">
					<p class="P21">
			...
			<tr class="Tabla37">
				<td colspan="6" style="text-align:left;width:1.282cm; " class="Tabla3_A7">
					<p class="P18">&nbsp;</p>
				</td>
			...
			<tr class="Tabla36">
				<td colspan="31" style="text-align:center;width:1.282cm; " class="Tabla3_A8">
					<span class="P122">Nombre y firma del patrón o representante legal de la empresa</span>
				</td>
			</tr>
			<tr class="Tabla36">
				<td colspan="31" style="text-align:left;width:1.282cm; " class="Tabla3_A9">
					<p class="P4">&nbsp;</p>
				</td>
			</tr>
			<tr class="Tabla36">
				<td colspan="31" style="text-align:center;width:1.282cm; " class="Tabla3_A10">
					<span class="P1222">Lugar y fecha de elaboración de este informe</span>
				</td>
			</tr>
			<tr class="Tabla36">
				<td colspan="31" style="text-align:center;width:1.282cm; " class="Tabla3_A11">
					<p class="P20"></p>
				</td>
			</tr>
			<tr class="Tabla33">
				<td colspan="19" style="text-align:center;width:1.282cm; " class="Tabla3_A12">
					<p class="P15"><?= $model->LUGAR_INFORME?></p>
				</td>
				<td colspan="4" style="text-align:left;width:0.598cm; " class="Tabla3_O12">
					<p class="P15"> </p>
				</td>
				<td colspan="2" style="text-align:left;width:0.609cm; " class="Tabla3_U12">
					<p class="P15"> </p>
				</td>
				<td colspan="2" style="text-align:left;width:0.677cm; " class="Tabla3_Y12">
					<p class="P15"> </p>
				</td>
				<td colspan="4" style="text-align:left;width:0.6cm; " class="Tabla3_b12">
					<p class="P15"> </p>
				</td>
			</tr>
			<tr class="Tabla313">
				<td colspan="4" style="text-align:left;width:1.282cm; " class="Tabla3_A13">
					<p class="P15"> </p>
				</td>
				<td colspan="14" style="text-align:left;width:0.709cm; " class="Tabla3_E13">
					<p class="P29">
						<span class="T28"></span></p>
				</td>
				<td style="text-align:left;width:0.945cm; " class="Tabla3_N13">
					<p class="P15"> </p>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
				...
				<td colspan="4" style="text-align:left;width:0.6cm; " class="Tabla3_b13">
					<p class="P17">&nbsp;</p>
				</td>
			</tr>
			<tr class="Tabla314">
				<td colspan="19" style="text-align:left;width:1.282cm; " class="Tabla3_A14">
					<p class="P15"> </p>
				</td>
				<td colspan="4" style="text-align:center;width:0.598cm; " class="Tabla3_O14">
					<span class="P122">Año</span>
				</td>
				<td colspan="2" style="text-align:center;width:0.609cm; " class="Tabla3_U14">
					<span class="P122">Mes</p>
				</td>
				<td colspan="2" style="text-align:center;width:0.677cm; " class="Tabla3_Y14">
					<span class="P122">Día</p>
				</td>
				<td colspan="4" style="text-align:left;width:0.6cm; " class="Tabla3_b14">
					<p class="P14">&nbsp;</p>
				</td>
			</tr>
		</table>
		...
		<p class="P30">
			...
			<span class="T25">-  Llenar a máquina o con letra de molde.</span>
		...
		<p class="P34" style="text-align:right;">DC-4 ANVERSO (primera parte)</p>
		...
		<div class="" style="position: relative; width: 100%; height: 30px;">
			<!-- Padding -->		
		</div>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="Tabla4">
			...
			<tr class="Tabla41">
				<td colspan="4" style="text-align:center;width:1.623cm; " class="Tabla4_A1">
					<h5 class="Heading_20_5">
						<a id="a__ESTABLECIMIENTOS_EN_LOS_QUE_RIGE_LA_COMISIÓN_MIXTA_DE_CAPACITACIÓN__ADIESTRAMIENTO_Y_PRODUCTIVIDAD">
							<span />
						</a>
						<span class="T10">ESTABLECIMIENTOS CONSIDERADOS EN LA LISTA DE CONSTANCIAS DE COMPETENCIAS O DE HABILIDADES LABORALES DE CAPACITACIÓN, ADIESTRAMIENTO Y PRODUCTIVIDAD</span>
					</h5>
				</td>
			</tr>
			<tr class="Tabla42">
				<td style="text-align:center;width:1.623cm; " class="Tabla4_A2">
					<p class="P122">Número</p><p class="P122">consecutivo</p>
				</td>
				<td style="text-align:center;width:11.035cm; " class="Tabla4_B2">
					<p class="P122">Domicilio</p><p class="P21">
						<span class="P122">(Anotar el domicilio conforme a los datos solicitados en el anverso de este formato, para cada uno de los establecimientos adicionales)</span>
					</p>
				</td>
				<td style="text-align:center;width:3.249cm; " class="Tabla4_C2">
					<p class="P122">R.F.C. con homoclave</p><p class="P122">(SHCP)</p>
				</td>
				<td style="text-align:center;width:3.776cm; " class="Tabla4_D2">
					<p class="P122">Registro patronal del I.M.S.S.</p>
				</td>
			</tr>
			...
			<?php for($i=0; $i<35; $i++){?>
			<tr class="Tabla43">
				<td style="text-align:center;width:1.623cm; " class="Tabla4_A3">
					<p class="P7">
						<span class="T28">
						<?php
						if (isset($modelEst[$i]))
				...
				<td style="text-align:left;width:11.035cm; " class="Tabla4_B3">
					<p class="P9">
						<span class="T28"><?php 
				...
				<td style="text-align:left;width:3.249cm; " class="Tabla4_C3">
					<p class="P7">
						<span class="T28"><?php
						if (isset($modelEst[$i]))
							echo $modelEst[$i]->RFC;
				...
				<td style="text-align:left;width:3.776cm; " class="Tabla4_D3">
					<p class="P7">
						<span class="T28"><?php
						if (isset($modelEst[$i]))
							echo $modelEst[$i]->NSS;
			...
			<?php }?>
			<tr class="Tabla43">
				<td style="text-align:left;width:1.623cm; " class="Tabla4_A31">
					<p class="P7">
						<span class="T28"></span></p>
				</td>
				<td style="text-align:left;width:11.035cm; " class="Tabla4_B31">
					<p class="P9">
						<span class="T28"></span></p>
				</td>
				<td style="text-align:left;width:3.249cm; " class="Tabla4_C31">
					<p class="P7">
						<span class="T28"></span></p>
				</td>
				<td style="text-align:left;width:3.776cm; " class="Tabla4_D31">
					<p class="P7">
						<span class="T28"></span></p>
				</td>
			</tr>
		</table><p class="P36"> </p><p class="P32"> </p><p class="P30">
			<span class="T27">Consultas sobre el trámite llamar a la Dirección General de Capacitación al Teléfono 2000-5126 o realizar la consulta al correo electrónico registro@stps.gob.mx</span>
		</p><p class="P34" style="text-align:right">DC-4 REVERSO (primera parte)</p>
	...
	?>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="Tabla1">
			...
			div' is a draw:frame.
		-->
						<div style="height:3.016cm;width:3.44cm; padding:0;  float:left; position:relative; left:0.161cm; top:0.949cm; " class="fr1" id="Imagen_7">
							
						</div>
					</div>
					<div style="clear:both; line-height:0; width:0; height:0; margin:0; padding:0;"> 
					   <img style="height:3.016cm;width:3.44cm;" alt="" src="data:image/*;base64,"></div>
				</td>
				<td style="text-align:center;width:15.977cm; " class="Tabla1_B1">
					<p class="P45"> </p><p class="P43">
						<span class="T2">SUBSECRETARÍA DE INCLUSIÓN LABORAL</span>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="Tabla2">
			...
			<tr class="Tabla21">
				<td colspan="35" style="text-align:center;width:0.679cm; height:30px; " class="Tabla2_A1 P400">
							DATOS DEL TRABAJADOR
				</td>
			</tr>
			<tr class="Tabla22">
				<td colspan="35" style="text-align:left;width:0.679cm;  vertical-align:top;" class="Tabla2_A2">
					<span class="P122">Apellido paterno, materno, nombres (s)</span>
					
				</td>
			</tr>
			<tr class="Tabla23">
				<td colspan="35" style="text-align:left;width:0.679cm; height:30px" class="Tabla2_A3">
					<span class="T28"><?=$trabajador->APP.' '.$trabajador->APM. ' ' .$trabajador->NOMBRE ?></span> 
					
				</td>
			</tr>
			<tr class="Tabla22">
				<td colspan="18" style="text-align:left;width:0.679cm; " class="Tabla2_A4">
					<span class="P122">Clave Única de Registro de Población</span>
				</td>
				<td colspan="17" style="text-align:left; width:365px " class="Tabla2_S4">
						<span class="P122">Ocupación específica (consultar catálogo al reverso)</span>
				</td>
			</tr>
			<tr class="Tabla25">
				<td style="text-align:center; vertical-align:middle; width:0.679cm; height:30 " class="Tabla2_A5 T28">
					<?=trim(isset($a_curp[0])?$a_curp[0]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_curp[1])?$a_curp[1]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_curp[2])?$a_curp[2]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_curp[3])?$a_curp[3]:'') ?>
				</td>
				<td  style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[4])?$a_curp[4]:'') ?>
				</td>
				<td  style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_curp[5])?$a_curp[5]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_curp[6])?$a_curp[6]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_curp[7])?$a_curp[7]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[8])?$a_curp[8]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[9])?$a_curp[9]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[10])?$a_curp[10]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle;width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[11])?$a_curp[11]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[12])?$a_curp[12]:'') ?>
				</td>
				<td  style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[13])?$a_curp[13]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[14])?$a_curp[14]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[15])?$a_curp[15]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[16])?$a_curp[16]:'') ?>
				</td>
				
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
						<?=trim(isset($a_curp[17])?$a_curp[17]:'') ?>
				</td>
			...
			<tr class="Tabla22">
				<td colspan="6" style="text-align:left; height:30px;   " class="Tabla2_A14_1">
					<span class="P122">Lugar de recidencia</span>
				</td>
				<td colspan="11" style="text-align:left; " class="Tabla2_A14_1">
					<span class="P122">Entidad federativa:&nbsp; <span class="T28"><?= isset($entidadFederativa)?$entidadFederativa->NOMBRE: '';?></span></span>
				</td>
				<td colspan="18" style="text-align:left; " class="Tabla2_A14_1">
					<span class="P122">Municipio o delegación política:&nbsp; <span class="T28"> <?= isset($mpio)?$mpio->NOMBRE: '';?></span></span>
				</td>
			</tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="Tabla2">
			...
			<tr class="Tabla21">
				<td colspan="27" style="text-align:center;width:0.679cm; height:30px; " class="Tabla2_A1 P400">
							DATOS DE CERTIFICACIÓN DE COMPETENCIAS LABORALES
				</td>
			</tr>
			<tr class="Tabla22">
			<td colspan="14" style="text-align:left;" class="Tabla2_S4">
					<span class="P122">
						<span class="T1">Nombre de la norma  o estándar*</span>
					</span>
				</td>
				<td colspan="13" style="text-align:left; " class="Tabla2_S4">
					<span class="P122">Fecha de emisión del certificado*</span>
				</td>
				
			</tr>
			<tr class="Tabla23">
			<td colspan="14" style="text-align:center;width:0.679cm; height:20px;" class="Tabla3_A10">
					<span class="T28"></span>
				</td>
				<td colspan="3" style="text-align:left;width:0.679cm; " class="Tabla2_A99">
					<span class="T28">&nbsp;</span>
				</td>
				<td colspan="4" style="text-align:center;width:0.679cm; " class="Tabla3_A111">
					<span class="P122">Año</span>
				</td>
				<td colspan="2" style="text-align:center;width:0.679cm; " class="Tabla3_A111">
					<span class="P122">Mes</span>
				</td>
				<td colspan="2" style="text-align:center;width:0.679cm; " class="Tabla3_A111">
					<span class="P122">Día</span>
				</td>
				<td colspan="2" style="text-align:center;width:0.679cm; " class="Tabla3_A100">
					<p class="P2">
					</p>
				</td>
			...
			<tr class="Tabla36">
				<td colspan="14" style="text-align:center;width:0.679cm; height:5px" class="Tabla3_A10">
					<p class="P2"></p>
				</td>
				<td colspan="3" style="text-align:center;width:0.679cm; " class="Tabla3_A10">
					<p class="P2">
					
					</p>
				</td>
				<td colspan="4" style="text-align:center;width:0.679cm; " class="Tabla3_A10">
					<p class="P2">
					</p>
				</td>
				<td colspan="2" style="text-align:center;width:0.679cm; " class="Tabla3_A10">
					<p class="P2">&nbsp;
					</p>
				</td>
				<td colspan="2" style="text-align:center;width:0.679cm; " class="Tabla3_A10">
			...
			<tr class="Tabla25">
				...
				<td colspan="3" style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 P7">
						
				</td>
				
				
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fEmisionCertificado[0])?$a_fEmisionCertificado[0]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fEmisionCertificado[1])?$a_fEmisionCertificado[1]:'') ?>
				</td>
				
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fEmisionCertificado[2])?$a_fEmisionCertificado[2]:'') ?>
				</td>
				<td  style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fEmisionCertificado[3])?$a_fEmisionCertificado[3]:'') ?>
				</td>
				
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fEmisionCertificado[4])?$a_fEmisionCertificado[4]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fEmisionCertificado[5])?$a_fEmisionCertificado[5]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fEmisionCertificado[6])?$a_fEmisionCertificado[6]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fEmisionCertificado[7])?$a_fEmisionCertificado[7]:'') ?>
				</td>
				<td colspan="2" style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_e5 P7">
	...
	<span class="T22"> </span>
		<table border="0" cellspacing="0" cellpadding="0" class="Tabla2">
			...
			<tr class="Tabla26">
				<td colspan="9" style="text-align:left;width:0.679cm; " class="Tabla2_A6">
					<span class="P122">Nivel máximo de estudios terminados</span>
				</td>
				<td  style="text-align:center; width:0.1cm; " class="Tabla2_A5 T28">
					<?= $trabajador->GRADO_ESTUDIO; ?>
				</td>
				<td colspan="4" style="text-align:left;width:0.679cm; " class="Tabla2_A6">
					<p class="P51"></p>
				</td>
				<td colspan="8" style="text-align:left;width:0.679cm; " class="Tabla2_A6">
					<span class="P122">Documento probatorio</span>
				</td>
				<td  style="text-align:center; " class="Tabla2_A5 T28">
					<?= $trabajador->DOCUMENTO_PROBATORIO; ?>
				</td>
				<td colspan="4" style="text-align:left;width:0.679cm; " class="Tabla2_A6">
			...
			<tr class="Tabla26">
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LS_RN">
					<p class="Standard">
						<span class="T12"></span>
					</p>
				</td>
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
						<span class="T12">&nbsp;</span>
					</p>
				</td>
				<td colspan="2" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
						
					</p>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla_TN_BN_LS_RS">
					<p class="P2"></p>
				</td>
			</tr>
			<tr class="Tabla26">
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LS_RN">
					<p class="Standard">
						<span class="P122">&nbsp;0. Ninguno</span>
					</p>
				</td>
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
			...
			<tr class="Tabla26">
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LS_RN">
					<p class="Standard">
						<span class="P122">1. Primaria</span>
					</p>
				</td>
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
						<span class="P122">&nbsp;5. Licenciatura</span>
					</p>
				</td>
				<td colspan="2" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
			...
			<tr class="Tabla26">
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LS_RN">
					<p class="Standard">
						<span class="P122">2. Secundaria</span>
					</p>
				</td>
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
						<span class="P122">&nbsp;6. Especialidad</span>
					</p>
				</td>
				<td colspan="2" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
				...
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla_TN_BN_LS_RS">
					<p class="Standard">
						<span class="P122">&nbsp;2. Certificado</span>
					</p>
				</td>
			</tr>
			<tr class="Tabla26">
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LS_RN">
					<p class="Standard">
						<span class="P122">3. Bachillerato</span>
					</p>
				</td>
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
						<span class="P122">&nbsp;7. Maestría</span>
					</p>
				</td>
				<td colspan="2" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
				...
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla_TN_BN_LS_RS">
					<p class="Standard">
						<span class="P122">&nbsp;3. Diploma</span>
					</p>
				</td>
			</tr>
			<tr class="Tabla26">
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LS_RN">
					<p class="Standard">
						<span class="P122">4. Carrera técnica</span>
					</p>
				</td>
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
						<span class="P122">&nbsp;8. Doctorado</span>
					</p>
				</td>
				<td colspan="2" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
			...
			<tr class="Tabla26">
				<td colspan="9" style="text-align:left;width:0.679cm; " class="Tabla2_A6">
					<span class="P122">Institución educativa*</span>
				</td>
				<td colspan="1" style="text-align:center;" class="Tabla_TS_BS_LS_RS T28">
					<?= $trabajador->INSTITUCION_EDUCATIVA; ?>
				</td>
				<td colspan="17" style="text-align:left;width:0.679cm; " class="Tabla2_A6">
					<p class="P51"></p>
				</td>
				
			</tr>
				<tr class="Tabla27">
				<td colspan="27" style="text-align:left;width:0.191cm; " class="Tabla_TN_BN_LS_RS">
					<p class="Standard">
						<span class="T12"></span>
					</p>
				</td>
			...
			<tr class="Tabla27">
				<td colspan="27" style="text-align:left;width:0.191cm; " class="Tabla_TN_BN_LS_RS">
					<p class="Standard">
						<span class="P122">&nbsp;1. Pública</span>
					</p>
				</td>
			</tr>
			<tr class="Tabla27">
				<td colspan="27" style="text-align:left;width:0.191cm; " class="Tabla_TN_BS_LS_RS">
					<p class="Standard">
						<span class="P122">&nbsp;2. Privada</span>
					</p>
				</td>
			</tr>
			</table>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="Tabla2">
			...
			<tr class="Tabla26">
				<td colspan="14" style="text-align:left;width:0.679cm; " class="Tabla2_A12">
						...
						<span class="P122">Nombre del curso</span>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla2_Q12">
					<span class="P122">Duración (horas)</span>
				</td>
			</tr>
			<tr class="Tabla213">
				<td colspan="14" style="text-align:left;width:0.679cm; height:20px; " class="Tabla2_A13">
					<p class="P6">
						<span class="T28"><?=$curso->NOMBRE; ?></span></p>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla2_Q13">
					<p class="P6">
						<span class="T28"><?=$curso->DURACION_HORAS; ?></span></p>
				</td>
			</tr>
			<tr class="Tabla26">
				<td colspan="14" style="text-align:left;width:0.679cm; " class="Tabla2_A12">
						<span class="P122">Area temática del curso (Consultar catálogo al reverso)</span>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla2_Q12">
					<span class="P122">Fecha de término</span>
				</td>
			</tr>
			<tr class="Tabla23">
			<td colspan="14" style="text-align:center;width:0.679cm; height:20px" class="Tabla3_A10">
			...
			<tr class="Tabla25">
				<td colspan="14" style="text-align:left; vertical-align:middle; width:0.679cm; height:20 " class="Tabla2_A7 T28">
						<?=trim(isset($areaTematica)?$areaTematica->NOMBRE:'') ?>
				</td>
				...
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fTerminoCurso[0])?$a_fTerminoCurso[0]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fTerminoCurso[1])?$a_fTerminoCurso[1]:'') ?>
				</td>
				
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fTerminoCurso[2])?$a_fTerminoCurso[2]:'') ?>
				</td>
				<td  style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fTerminoCurso[3])?$a_fTerminoCurso[3]:'') ?>
				</td>
				
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fTerminoCurso[4])?$a_fTerminoCurso[4]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fTerminoCurso[5])?$a_fTerminoCurso[5]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fTerminoCurso[6])?$a_fTerminoCurso[6]:'') ?>
				</td>
				<td style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_A5 T28">
					<?=trim(isset($a_fTerminoCurso[7])?$a_fTerminoCurso[7]:'') ?>
				</td>
				<td colspan="2" style="text-align:center; vertical-align:middle; width:0.679cm; " class="Tabla2_e5 P7">
			...
			<tr class="Tabla26">
				<td colspan="14" style="text-align:left; vertical-align:top; width:0.679cm; " class="Tabla2_A12">
						<span class="P122">Agente capacitador</span>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla2_Q12">
					<span class="P122">N°de registro de agente capacitador externo ante la STPS o en caso de otro especificar(proveedor de bienes y servicios; extranjeros; STPS)</span>
				</td>
			</tr>
			<tr class="Tabla213">
				
				<td colspan="2" style="text-align:left;width:0.679cm; height:20px; " class="Tabla_TN_BN_LS_RN">
					<p class="P6">
						<span class="P122">1. Interno</span></p>
					</td>
				<td colspan="1" style="text-align:left;width:0.679cm; height:20px; " class="Tabla_TS_BS_LS_RS">
					<p class="P6">
						<span class="T28"><?php 
						
						if (isset($agente) && $agente->TIPO_INSTRUCTOR === 1){
				...
				<td colspan="1" style="text-align:left;width:0.679cm; height:20px; " class="Tabla_TN_BN_LN_RN">
					<p class="P6">
						<span class="T28">&nbsp;</span></p>
				</td>
				<td colspan="3" style="text-align:left;width:0.679cm; height:20px; " class="Tabla_TN_BN_LN_RN">
					<p class="P6">
						<span class="P122">2. Externo</span></p>
				</td>
				<td colspan="1" style="text-align:left;width:0.679cm; height:20px; " class="Tabla_TS_BS_LS_RS">
					<p class="P6">
						<span class="T28"><?php 
						
						if (isset($agente) && $agente->TIPO_INSTRUCTOR === 2){
				...
				<td rowspan="2" colspan="13" style="text-align:left;width:0.191cm; " class="Tabla2_Q13">
						<span class="T28"><?= isset($agente)?$agente->NUM_REGISTRO_AGENTE_EXTERNO : ' ';?></span>
				</td>
			</tr>
			<tr class="Tabla27">
				<td colspan="14" style="text-align:left;width:0.679cm; height:10px; " class="Tabla2_A7">
					<p class="P11"> </p><p class="P52">
						<span class="T28"></span></p>
				</td>
			</tr>
			<tr class="Tabla26">
				...
				<tr class="Tabla26">
				<td colspan="6" style="text-align:left;width:0.679cm; height:10px; " class="Tabla_TN_BN_LS_RN">
					<p class="Standard">
						<span class="T12"></span>
					</p>
				</td>
			...
			<tr class="Tabla26">
				...
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla_TN_BN_LS_RS">
					<p class="Standard">
						<span class="P122">&nbsp;1. Actualizar y perfeccionar conocimientos y habilidades y proporcionar información de nuevas tecnologías</span>
					</p>
				</td>
			</tr>
			<tr class="Tabla26">
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LS_RN">
					<p class="Standard">
						<span class="P122">&nbsp;1. Presencial</span>
					</p>
				</td>
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
				...
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla_TN_BN_LS_RS">
					<p class="Standard">
						<span class="P122">&nbsp;2. Prevenir riesgos de trabajo</span>
					</p>
				</td>
			</tr>
			<tr class="Tabla26">
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LS_RN">
					<p class="Standard">
						<span class="P122">&nbsp;2. En linea</span>
					</p>
				</td>
				<td colspan="6" style="text-align:left;width:0.679cm; " class="Tabla_TN_BN_LN_RN">
					<p class="Standard">
				...
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla_TN_BN_LS_RS">
					<p class="Standard">
						<span class="P122">&nbsp;3. Incrementar la productividad</span>
					</p>
				</td>
			</tr>
			<tr class="Tabla26">
				...
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla_TN_BN_LS_RS">
					<p class="Standard">
						<span class="P122">&nbsp;4. Mejorar el nivel educativo</span>
					</p>
				</td>
			</tr>
			<tr class="Tabla26">
				
				<td colspan="14" style="text-align:left;width:0.679cm; " class="Tabla_TN_BS_LS_RS">
					<p class="Standard">
						
					</p>
				</td>
				<td colspan="13" style="text-align:left;width:0.191cm; " class="Tabla_TN_BS_LS_RS">
					<p class="Standard">
						<span class="P122">&nbsp;5. Preparar para ocupar vacantes o puestos de nueva creación</span>
					</p>
				</td>
			</tr>
			...
			<table>
				<tr>					
					<td><span class="T25">* Datos no obligatorios  </span></td>
					<td  style="text-align:right; width: 16cm"  ><p class="P34">  DC-4 ANVERSO (segunda parte)</p></td>
				</tr>
			</table>
		...
		<div class="P42">
			...
			div' is a draw:frame.
		-->
			<div style="width:100%; padding:0;  float:left; position:relative; left:2.223cm; " class="fr1" id="Marco1">
				...
				<div style="min-height:0.058cm;">
					<table border="0" cellspacing="0" cellpadding="0" class="Tabla5">
						...
						<tr class="Tabla51">
							<td style="text-align:left;width:2.23cm; " class="Tabla5_A1 P300">
								CLAVE DEL ÁREA/SUBÁREA
							</td>
							<td style="text-align:left;width:6.668cm; " class="Tabla5_A1 P300">
		...
		<p class="P41" style="text-align: center;">
			<span class="P300" style="text-align: center;">CLAVES Y DENOMINACIONES DEL CATÁLOGO DE ÁREAS TEMÁTICAS DE LOS CURSOS</span>
		</p>
		<!--Next 'div' was a 'text:p'.-->
		<div class="P42">
			<!--Next 'div' is emulating the top hight of a draw:frame.-->
			...
			div' is a draw:frame.
		-->
			<div style="width:100%; padding:0;  float:left; position:relative; left:2.223cm; " class="fr1" id="Marco2">
				<!--Next 'div' was a 'draw:text-box'.-->
				<div style="min-height:0.058cm;">
					<table border="0" cellspacing="0" cellpadding="0" class="Tabla6">
						...
						<tr class="Tabla61">
							<td style="text-align:left;width:2.223cm; " class="Tabla6_A1">
								<p class="P300">CLAVE DEL ÁREA </p>
							</td>
							<td style="text-align:left;width:6.668cm; " class="Tabla6_A1">
								<p class="P300">DENOMINACIÓN</p>
							</td>
		...
		<p class="P34" style="text-align:right;">DC-4 REVERSO (segunda parte)</p>
		
		<div class="" style="position: relative; width: 100%; height: 100px;">
			<!-- Padding -->		
		</div>
