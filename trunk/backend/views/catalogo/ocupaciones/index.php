...
$this->title = 'Catálogo nacional de ocupaciones.';
...
<div class="catalogo-index">
    ...
    <p>
        <?= Html::a('Crear nuevo', ['ocupaciones-crear'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
    		...
    		'urlCreator' => function ($action, $model, $key, $index) {
    			...
    			if ($action === 'update') {
    				return Yii::$app->urlManager->createUrl(['/catalogo/ocupaciones-actualizar', 'id' => $key]); // Aqui es donde se crean las urls con las acciones personalizadas
    		
    			}
    				
    			if ($action === 'delete') {
    				return Yii::$app->urlManager->createUrl(['/catalogo/ocupaciones-borrar', 'id' => $key]); // Aqui es donde se crean las urls con las acciones personalizadas
