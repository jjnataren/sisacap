...
<p>
        <?= Html::a('<i class="fa fa-pencil"></i> Actualizar', ['updatebystablish', 'id' => $model->ID_TRABAJADOR], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('<i class="fa fa-trash-o"></i> Eliminar', ['deletebystablish', 'id' => $model->ID_TRABAJADOR], [
